        ...
        <div className="activity-grid">
          ...
          <div className="activity-card">
            <div className="ac-head">
              ...
              <button className="lb-link" onClick={() => router.push("/leaderboard")}>
                VER SALÓN →
              </button>
            </div>
        ...
        <div className="pricing-grid">
          ...
          <div className="pricing-faq">
            <div className="faq-item">
              ...
              <div className="faq-a">
                Sí. Arcade Vault es un proyecto sin fines de lucro hecho por amor a los clásicos. No hay versión &quot;premium&quot;
                escondida.
              </div>
            </div>
            <div className="faq-item">
              ...
              <div className="faq-a">
                No. Puedes jugar como invitado. Si quieres guardar tu puntuación y aparecer en el ranking, regístrate en 10
                segundos.
              </div>
            </div>
            <div className="faq-item">
